...
from core.utils import parse_time_to_seconds, seconds_to_ffmpeg_time, get_ffmpeg_path
...
def download_fragment(
    ...
    # --- 4. Получаем путь к FFmpeg ---
    # Функция get_ffmpeg_path() сначала ищет встроенный ffmpeg.exe
    # (в папке ffmpeg/ рядом с приложением), а если не находит —
    # возвращает просто "ffmpeg" для поиска в системном PATH.
    ffmpeg_path = get_ffmpeg_path()

    # --- 5. Формируем команду FFmpeg ---
    ...
    # --- 6. Выводим информацию для отладки ---
